							...
							<tbody>
								...
								if($rs->num_rows >0){
									while($row = $rs->fetch_assoc()){
										$id  = $row['wc_id']; ?>
									<tr>
										<td colspan="6" style="border: 1px solid #dddddd;text-align: left;padding: 8px;">
										...
										<?php
										 ...
										 ?>
											 <tr>
												...
												<td style="border: 1px solid #dddddd;text-align: left;padding: 8px;"> <?= $row_data['wd_validity'] ?> </td>
											</tr>
									<?php } } ?>
