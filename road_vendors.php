				...
				<div class="content">
					...
					<div class="card">
						<div class="card-body">
							<div class="row">
								<div class="col-4">
									<form class="" action="backend/add_road_vendors.php" method="post">
		...
		<div class="modal fade" id="edit_RoadVendor" tabindex="-1" aria-labelledby="edit_RoadVendor"  aria-hidden="true">
    ...
    <?php include './layouts/footer.php' ?>
		<script type="text/javascript">
            function openEditRoadVendorData(id){
