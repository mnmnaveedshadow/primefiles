...
<input type="checkbox" name="" id="clear_data_pack_land" value="">
<label for="">Don't clear data when adding a package.</label> <br> <br>
<button type="button" id="add-package" onclick="add_package_detailsDeskLand()" class="btn btn-primary">Add Package</button> <br><br>

		<div class="col-12" id="show_packages_land">
