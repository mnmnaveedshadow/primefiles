...
<div class="col-md-2">
		...
		<div class="col-md-2">
			<div class="form-group">
					...
					<select name="" id="u_conv" class="form-control" onchange="convertUnits()">
...
<input type="checkbox" name="" id="clear_data_pack_sea" value="">
<label for="">Don't clear data when adding a package.</label> <br> <br>
<button type="button" id="add-package" onclick="add_package_detailsDeskSea()" class="btn btn-primary">Add Package</button> <br><br>

		<div class="col-12" id="show_packages_sea">
