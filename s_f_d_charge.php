				...
				<div class="content">
					<div class="page-header">
						<div class="page-title">
							<h4>Sea Freight Destination Charge</h4>
						</div>
					</div>
					<!-- /add -->
		...
		<div class="modal fade" id="edit_d_s" tabindex="-1" aria-labelledby="edit_d_s" aria-hidden="true">
				<div class="modal-dialog modal-xl modal-dialog-centered" role="document">
						<div class="modal-content">
								<div class="modal-header">
										<h5 class="modal-title">Edit Sea Freight Destination Charge</h5>
										<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
												<span aria-hidden="true">×</span>
										</button>
								</div>
								<div class="modal-body" id="edit_d_sea_charge">
    ...
    <?php include './layouts/footer.php' ?>
		...
		function openSfdEdit(id){
			$('#edit_d_s').modal('show');
			$('#edit_d_sea_charge').load('ajax_pages/edit_d_sea_charge.php',{
				s_dc_id:id
			});
		}

		function editSfdCharge(){
			var sdc_id = document.getElementById('sdc_id').value;
			...
			var container_id = document.getElementById('container_idEdit').value;
			var remark = document.getElementById('remarkEdit').value;


			$.ajax({
				url:'backend/edit_sfd_charge.php',
				method:'POST',
				data:{
					id:sdc_id,
