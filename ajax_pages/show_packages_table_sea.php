          ...
          while ($row = $rs->fetch_assoc()) {
              ...
              <tr>
                ...
                <td> <?= getDataBack($conn,'tbl_package_type','pt_id',$ptId,'pt_name'); ?> </td>
                  ...
                  <td><?= $row['p_weight'] ?></td>
                  <td><a onclick="del_p_desktopSea(<?= $row['p_id'] ?>)" class="btn btn-danger btn-sm"> X </a></td>
              </tr>
          <?php }
...
<br><br>
		<button type="button" name="button" class="btn btn-success" onclick="shippingSubmit(2,5)">Next</button> <br>
