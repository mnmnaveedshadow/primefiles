...
<?php
$id = $_REQUEST['lo_id'];
$sql = "SELECT * FROM `tbl_road_orgin_charge` WHERE roc_id='$id'";
...
if($rs->num_rows >0){
  $row = $rs->fetch_assoc();
    ...
    $service = $row['roc_tos'];
     ...
     ?>
     <input type="hidden" id="lo_id" name="" value="<?= $id ?>">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="descEdit" placeholder="Description" name="description" value="<?= $row['roc_desc'] ?>" required>
</div>
<div class="form-group">
...
<div class="form-group">
    <label for="">Aed</label>
    <input type="number" class="form-control" id="aedEdit" placeholder="Aed" name="aed" value="<?= $row['roc_charge'] ?>" required>
</div>
<div class="form-group">
    <label for="">Min Aed</label>
    <input type="number" class="form-control" id="min_aedEdit" placeholder="Min Aed" name="min_aed" value="<?= $row['roc_min'] ?>" required>
</div>
<div class="form-group">
    <label for="">VALIDITY</label>
    <input type="date" class="form-control" id="validityEdit" placeholder="VALIDITY" name="validity" value="<?= $row['roc_validity'] ?>" required>
</div>
<button type="button" class="btn btn-primary btn-me2" onclick="editlfoCharge()" name="button">Add</button>
<br><br>
