...
ob_start();
include '../calculated_quote_warehouseing.php';
$html = ob_get_clean();
...
$to = $cEmail;
$subject = "Your Customized Quote for Warehousing";
$message = "
Dear $cName, <br>
...
<br><br> <br>
 <hr> <br>
			<a href='https://skillheist.com/prime/accepted_quote_warehousing.php?qid=$qid' style='color:#fff;background:#000;border-radius:10px;padding:10px 10px 10px 10px;text-decoration:none;'> Accept The Quote </a> <br><br>
 <hr> <br>";
